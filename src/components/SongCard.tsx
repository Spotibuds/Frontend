        ...
        <div className="flex items-center space-x-3">
          ...
          {index !== undefined && (
            <div className="w-8 flex items-center justify-center">
              ...
              <button
                onClick={handlePlay}
                className="hidden group-hover:flex w-8 h-8 bg-purple-600 hover:bg-purple-700 rounded-full items-center justify-center transition-colors"
              >
          ...
          {/* Duration */}
          {showDuration && (
            <div className="text-gray-400 text-sm text-right min-w-12">
